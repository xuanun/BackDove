...
class GrainAlways extends Model
{
     ...
     * @return mixed
     */
    public function addData($item_id, $user_id, $factory_id, $production, $grain_name, $unit_price, $number,  $supplier, $examiner, $remarks)
    {
        try {
            $insertArray = [
                'item_id' => $item_id,
     ...
     * @return mixed
     */
    public function updateData( $production, $factory_id, $grain_name, $number, $type_id)
    {
        try {
            if($type_id == 1){
                DB::table($this->table)
